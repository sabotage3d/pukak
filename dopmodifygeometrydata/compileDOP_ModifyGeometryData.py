...
def usage():
    print( 'Usage: compileDOP_ModifyGeometryData.py [options]' )
...
dopModifyGeometrySrcPath = houdiniPath + '/toolkit/DOP_ModifyGeometryData/src'
dopModifyGeometrySrcPath = dopModifyGeometrySrcPath.replace( '\\', '/' )
os.chdir( dopModifyGeometrySrcPath )

#hcustomCommand = 'hcustom -i ../lib SOP_FractalGrowth.cpp'
hcustomCommand = 'hcustom DOP_ModifyGeometryData.cpp'
