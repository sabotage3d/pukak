...
def usage():
    print( 'Usage: compile_SIMGroupObjects.py [options]' )
...
simGroupObjectsSrcPath = houdiniPath + '/toolkit/SIM_GroupObjects/src'
simGroupObjectsSrcPath = simGroupObjectsSrcPath.replace( '\\', '/' )
os.chdir( simGroupObjectsSrcPath )

#hcustomCommand = 'hcustom -i ../lib SOP_FractalGrowth.cpp'
hcustomCommand = 'hcustom SIM_GroupObjects.cpp'
