#ifndef NONCONVEX_STACKING_CONSTRAINT_SOLVER_H
#define NONCONVEX_STACKING_CONSTRAINT_SOLVER_H
...
class shNonconvexStackingConstraintSolver : public btConstraintSolver
{
public:
	shNonconvexStackingConstraintSolver();
	virtual ~shNonconvexStackingConstraintSolver();
	virtual	void reset();
	...
	btScalar computeContactForDeepestNondivergingPointOnManifold( btPersistentManifold* manifold, const btContactSolverInfo& infoGlobal, btVector3& rBTot );	// Find the deepest intersecting point on the manifold and compute its contact
...
};  // class shNonconvexStackingConstraintSolver
