...
class SIM_BulletData : public SIM_Data,
...
class SIM_SolverBullet : public SIM_Solver, public SIM_OptionsUser
{
	...
	protected:
		...
		virtual std::map< int, bulletBody >::iterator SIM_SolverBullet::addBulletBody(SIM_Object *currObject);
		virtual void SIM_SolverBullet::removeDeadBodies(SIM_Engine &engine);
		virtual void SIM_SolverBullet::processSubData(SIM_Object *currObject, bulletBody &body);
