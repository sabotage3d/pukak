...
SIM_Solver::SIM_Result SIM_SolverBullet::solveObjectsSubclass(SIM_Engine &engine,
...
std::map< int, bulletBody >::iterator SIM_SolverBullet::addBulletBody(SIM_Object *currObject)
{
	std::map< int, bulletBody >::iterator bodyIt;
