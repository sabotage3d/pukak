    ...
    // *********************** //
        ...
        for ( i = 0; i < numBulletObjects; i++ )
        {
                ...
                for (int a = 0; a < colliders.entries(); a++)
                {
                        ...
                        // ADDED BY SRH 2010-06-11 //
           				// If the affector is marked as kinematic in the Bullet Data, that means it is animated,
           				//   so here we update the position and orientation of the object to match Houdini's object.
           				...
           				RBD_State *rbdstate = SIM_DATA_GET(*currObject, "Position", RBD_State);
           				bool isKinematic = bulletstate->getIsKinematic();
           				
           				//cout<<bulletstate->getIsKinematic<<endl;
