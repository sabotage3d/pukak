...
dopGroupCollidingObjectsSrcPath = houdiniPath + '/toolkit/DOP_GroupCollidingObjects/src'
dopGroupCollidingObjectsSrcPath = dopGroupCollidingObjectsSrcPath.replace( '\\', '/' )
os.chdir( dopGroupCollidingObjectsSrcPath )

#hcustomCommand = 'hcustom -i ../lib SOP_FractalGrowth.cpp'
hcustomCommand = 'hcustom DOP_GroupCollidingObjects.cpp'
